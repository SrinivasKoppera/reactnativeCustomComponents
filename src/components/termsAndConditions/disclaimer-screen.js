    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.paragraph}>
          The information provided by Zaapr Online Services Private Limited
          ('we', 'us', or 'our') on our mobile application is for general
          informational purposes only. All information on our mobile application
          ...
          information on our mobile application. UNDER NO CIRCUMSTANCE SHALL WE
          HAVE ANY LIABILITY TO YOU FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED
          AS A RESULT OF THE USE OF OUR MOBILE APPLICATION OR RELIANCE ON ANY
          INFORMATION PROVIDED ON OUR MOBILE APPLICATION. YOUR USE OF OUR MOBILE
          APPLICATION AND YOUR RELIANCE ON ANY INFORMATION ON OUR MOBILE
          APPLICATION IS SOLELY AT YOUR OWN RISK.
        </Text>

        <Text style={styles.sectionTitle}>EXTERNAL LINKS DISCLAIMER</Text>
        <Text style={styles.paragraph}>
          Our mobile application may contain (or you may be sent through our
          mobile application) links to other websites or content belonging to or
        ...
        <Text style={styles.paragraph}>
          Our mobile application may contain links to affiliate websites, and we
